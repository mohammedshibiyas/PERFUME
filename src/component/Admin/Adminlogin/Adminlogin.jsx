	...
	<div class="modal">
		...
		<div class="modal__body">
			...
			<div class="input">
                ...
                <input class="input__field" name='email' type="text" onChange={(e)=>setemail(e.target.value)} />
			</div>
           
            <div class="input">
				<label class="input__label">Password</label>
				<input class="input__field" name='password' type="password" onChange={(e)=>setPassword(e.target.value)}/> 
			</div>

          
		</div>
		<div class="modal__footer">
			<button class="button button--primary" onClick={Login}>Create project</button>
		</div>
	</div>
</div>
